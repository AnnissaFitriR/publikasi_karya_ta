...
<head>
    ...
    <title>Tambah Karya - LP3I Purwakarta</title>
    ...
    >
        ...
        <div style="margin-bottom:30px;">
            ...
            <p
                ...
                "
            >
                Bagikan karya terbaikmu ke galeri mahasiswa LP3I Purwakarta.
            </p>
        ...
        <form
            action="{{ route('mahasiswa.karya.store') }}"
            method="POST"
            ...
            >
                ...
                <div style="margin-bottom:25px;">
                    ...
                    <input
                        ...
                        value="{{ old('judul') }}"
                        required
                        placeholder="Contoh: Website Perpustakaan Digital"
                        style="
                            width:100%;
                            padding:14px 15px;
                ...
                <div style="margin-bottom:30px;">
                    ...
                    >
                        ...
                        <p
                            ...
                            "
                        >
                            Format yang dapat diunggah:
                            JPG, JPEG, PNG, PDF, DOC, DOCX, dan ZIP.
                        </p>
